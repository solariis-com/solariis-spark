export const es = {
  ...
  hero: {
    ...
    description: "Nos asociamos con marcas excepcionales de salud y belleza para adaptarnos y penetrar con éxito el mercado venezolano. Desde el cumplimiento normativo hasta la distribución y el marketing, garantizamos una entrada al mercado sin problemas y un crecimiento sostenible.",
    cta: {
