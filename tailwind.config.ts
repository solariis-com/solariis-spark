  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'body-lg': ['clamp(1.125rem, 2vw, 1.75rem)', { lineHeight: '1.6', fontWeight: '100' }],
        'body': ['clamp(1rem, 1.5vw, 1.5rem)', { lineHeight: '1.5', fontWeight: '100' }],
        'body-sm': ['clamp(0.875rem, 1.25vw, 1.25rem)', { lineHeight: '1.4', fontWeight: '100' }],
